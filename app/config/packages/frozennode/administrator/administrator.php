...
return array(
	 ...
	 */
	'menu' => array(
		'Items' => array('items','categories','tags','attributes','items_eav'),
		'Sales' =>array('orders','order-items','import-orders'),
		'Customers' => array('customers'),
		'Reports'   => array(
			'Item Reports' => array('item-sales','item-best-seller','items-havent-sold'),
			'customers_report' => array('customers-top','customers-havent-purchased'),

			),
		'Settings' => array('users','config','import')
		),
